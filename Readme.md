...
Please check the [Group 1 presentation_PPT-1.pdf](https://github.com/I-Paradox-I/TrafficSignRecongnition/blob/master/Group1_presentation_PPT-1.pdf) for more detailed introduction. 请查看文件列表中的ppt来更详细的查看这个项目。
### 文件结构介绍
